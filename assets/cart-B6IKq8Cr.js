import{a as l}from"./utils-B3jpzjNX.js";function o(){const t=l("so-cart")||[],a=document.querySelector(".product-list"),e=document.getElementById("cart-totals");if(!a)return;if(t.length===0){a.innerHTML="<p>Your cart is empty at the moment, please make a purchase while stock last.</p>",e&&(e.innerHTML="");return}const c=t.map(r=>m(r));a.innerHTML=c.join(""),document.querySelectorAll(".remove-from-cart").forEach(r=>{r.addEventListener("click",y)});let s=0,i=0;t.forEach(r=>{const d=r.quantity||1,g=r.SuggestedRetailPrice||r.ListPrice||r.FinalPrice||0,f=r.FinalPrice||r.ListPrice||0;s+=g*d,i+=f*d});const u=s-i;e&&(e.innerHTML=`
